# Stwórz aplikację, która pozwala użytkownikom tworzyć, usuwać i aktualizować zadania. Zadania powinny być przechowywane w pliku JSON. Każde zadanie powinno mieć tytuł, opis, i status (np. "do zrobienia", "w trakcie", "zrobione").
import json
